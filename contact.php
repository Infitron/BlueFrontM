          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Contact Us</h1>
                <p class="mb-0">Need more Info? Reach Out To Us</p>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-5"  data-aos="fade" data-aos-delay="100">
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-0"><a href="mailto:info@bluecollarhub.com">info@bluecollarhub.com</a></p>

            </div>
            
            <div class="p-4 mb-3 bg-white">
              <h3 class="h5 text-black mb-3">More Info</h3>
              <p>We are always pleased to help you</p>
              <p><a href="#" class="btn btn-primary px-4 py-2 text-white">Visit Us Here</a></p>
            </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            ...
            <p class="color-black-opacity-5">What Should You Know?</p>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-8">
            ...
            <div class="border p-3 rounded mb-2">
              <a data-toggle="collapse" href="#collapse-4" role="button" aria-expanded="false" aria-controls="collapse-4" class="accordion-item h5 d-block mb-0">Is this available in my area?</a>
            ...
            <div class="border p-3 rounded mb-2">
              <a data-toggle="collapse" href="#collapse-3" role="button" aria-expanded="false" aria-controls="collapse-3" class="accordion-item h5 d-block mb-0">How does the system works?</a>
