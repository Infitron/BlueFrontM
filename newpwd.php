          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>New Password</h1>
                <p class="mb-0">Set a New Password Below</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 mb-5"  data-aos="fade">
            ...
            <h2 class="mb-5 text-black">Password Reset</h2>
            ...
            <form action="#" class="p-5 bg-white">
			 <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-12">
                        <label class="text-black" for="username">Token Code</label>
                        <input type="text" id="tcode" name="tcode" class="form-control">
                    </div>
                </div>
