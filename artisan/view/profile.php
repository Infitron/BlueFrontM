                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <input type="text" id="idn" placeholder="" class="form-control" readonly="">
                                        </div>
                                        <div class="form-group">
                                            <label for="f_name" class=" form-control-label">First Name</label>
                                            <input type="text" id="f_name" placeholder="" class="form-control" readonly="">
                                        </div>
                                         <div class="form-group">
                                            <label for="f_name" class=" form-control-label">Last Name</label>
                                            <input type="text" id="l_name" placeholder="" class="form-control" readonly="">
                                        </div>
                                        <div class="form-group">
                                            <label for="phone" class=" form-control-label">Phone Number</label>
                                            <input type="text" id="phone" placeholder="" name="phone" class="form-control" readonly="">
                                        </div>
                                        <div class="form-group">
                                            <label for="email" class=" form-control-label">Email</label>
                                            <input type="text" id="email" placeholder="" name="email" class="form-control" readonly="">
                                        </div>
                                        <div class="form-group">
                                            <label for="about_me" class=" form-control-label">Information About Me</label>
                                            <textarea name="about_me" id="about_me" rows="9" placeholder="Content..." class="form-control" readonly="" ></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="address" class=" form-control-label">Address</label>
                                            <textarea name="address" id="address" rows="9" placeholder="Content..." class="form-control" readonly=""></textarea>
                                        </div>
                                         <div class="form-group">
                                            <label for="state" class=" form-control-label">State</label>
                                            <input type="text" id="state" placeholder="" name="state" class="form-control" readonly="">
                                        </div>
                                         <div class="form-group">
                                            <label for="country" class=" form-control-label">Country</label>
                                            <input type="text" id="country" placeholder="" name="country" class="form-control" readonly="">
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" id="category" placeholder="" name="category" class="form-control" readonly="">
                                        </div>
